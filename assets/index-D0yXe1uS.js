...
`].filter(vi).join(`
`)),a=ms(a),a=$a(a,e),a=ja(a,e),o=ms(o),o=$a(o,e),o=ja(o,e),a=Ka(a),o=Ka(o),e.isRawShaderMaterial!==!0&&(E=`#version 300 es
...
}`;function yp(i,t,e){let n=new ys;const r=new xt,s=new xt,a=new he,o=new xp({depthPacking:tc}),l=new Mp,c={},h=e.maxTextureSize,u={[Je]:Se,[Se]:Je,[Oe]:Oe},f=new mn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new xt},radius:{value:4}},vertexShader:Sp,fragmentShader:Ep}),g=f.clone();g.defines.HORIZONTAL_PASS=1;const x=new Me;x.setAttribute("position",new He(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const S=new ve(x,f),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=yo;let d=this.type;this.render=function(R,w,U){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||R.length===0)return;const b=i.getRenderTarget(),M=i.getActiveCubeFace(),I=i.getActiveMipmapLevel(),G=i.state;G.setBlending(dn),G.buffers.color.setClear(1,1,1,1),G.buffers.depth.setTest(!0),G.setScissorTest(!1);const P=d!==Ke&&this.type===Ke,Y=d===Ke&&this.type!==Ke;for(let W=0,K=R.length;W<K;W++){const Z=R[W],V=Z.shadow;if(V===void 0){console.warn("THREE.WebGLShadowMap:",Z,"has no shadow.");continue}if(V.autoUpdate===!1&&V.needsUpdate===!1)continue;r.copy(V.mapSize);const tt=V.getFrameExtents();if(r.multiply(tt),s.copy(V.mapSize),(r.x>h||r.y>h)&&(r.x>h&&(s.x=Math.floor(h/tt.x),r.x=s.x*tt.x,V.mapSize.x=s.x),r.y>h&&(s.y=Math.floor(h/tt.y),r.y=s.y*tt.y,V.mapSize.y=s.y)),V.map===null||P===!0||Y===!0){const ut=this.type!==Ke?{minFilter:Te,magFilter:Te}:{};V.map!==null&&V.map.dispose(),V.map=new Pn(r.x,r.y,ut),V.map.texture.name=Z.name+".shadowMap",V.camera.updateProjectionMatrix()}i.setRenderTarget(V.map),i.clear();const J=V.getViewportCount();for(let ut=0;ut<J;ut++){const Nt=V.getViewport(ut);a.set(s.x*Nt.x,s.y*Nt.y,s.x*Nt.z,s.y*Nt.w),G.viewport(a),V.updateMatrices(Z,ut),n=V.getFrustum(),T(w,U,V.camera,Z,this.type)}V.isPointLightShadow!==!0&&this.type===Ke&&E(V,U),V.needsUpdate=!1}d=this.type,p.needsUpdate=!1,i.setRenderTarget(b,M,I)};function E(R,w){const U=t.update(S);f.defines.VSM_SAMPLES!==R.blurSamples&&(f.defines.VSM_SAMPLES=R.blurSamples,g.defines.VSM_SAMPLES=R.blurSamples,f.needsUpdate=!0,g.needsUpdate=!0),R.mapPass===null&&(R.mapPass=new Pn(r.x,r.y)),f.uniforms.shadow_pass.value=R.map.texture,f.uniforms.resolution.value=R.mapSize,f.uniforms.radius.value=R.radius,i.setRenderTarget(R.mapPass),i.clear(),i.renderBufferDirect(w,null,U,f,S,null),g.uniforms.shadow_pass.value=R.mapPass.texture,g.uniforms.resolution.value=R.mapSize,g.uniforms.radius.value=R.radius,i.setRenderTarget(R.map),i.clear(),i.renderBufferDirect(w,null,U,g,S,null)}function v(R,w,U,b){let M=null;const I=U.isPointLight===!0?R.customDistanceMaterial:R.customDepthMaterial;if(I!==void 0)M=I;else if(M=U.isPointLight===!0?l:o,i.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0){const G=M.uuid,P=w.uuid;let Y=c[G];Y===void 0&&(Y={},c[G]=Y);let W=Y[P];W===void 0&&(W=M.clone(),Y[P]=W,w.addEventListener("dispose",L)),M=W}if(M.visible=w.visible,M.wireframe=w.wireframe,b===Ke?M.side=w.shadowSide!==null?w.shadowSide:w.side:M.side=w.shadowSide!==null?w.shadowSide:u[w.side],M.alphaMap=w.alphaMap,M.alphaTest=w.alphaTest,M.map=w.map,M.clipShadows=w.clipShadows,M.clippingPlanes=w.clippingPlanes,M.clipIntersection=w.clipIntersection,M.displacementMap=w.displacementMap,M.displacementScale=w.displacementScale,M.displacementBias=w.displacementBias,M.wireframeLinewidth=w.wireframeLinewidth,M.linewidth=w.linewidth,U.isPointLight===!0&&M.isMeshDistanceMaterial===!0){const G=i.properties.get(M);G.light=U}return M}function T(R,w,U,b,M){if(R.visible===!1)return;if(R.layers.test(w.layers)&&(R.isMesh||R.isLine||R.isPoints)&&(R.castShadow||R.receiveShadow&&M===Ke)&&(!R.frustumCulled||n.intersectsObject(R))){R.modelViewMatrix.multiplyMatrices(U.matrixWorldInverse,R.matrixWorld);const P=t.update(R),Y=R.material;if(Array.isArray(Y)){const W=P.groups;for(let K=0,Z=W.length;K<Z;K++){const V=W[K],tt=Y[V.materialIndex];if(tt&&tt.visible){const J=v(R,tt,b,M);R.onBeforeShadow(i,R,w,U,P,J,V),i.renderBufferDirect(U,null,P,J,R,V),R.onAfterShadow(i,R,w,U,P,J,V)}}}else if(Y.visible){const W=v(R,Y,b,M);R.onBeforeShadow(i,R,w,U,P,W,null),i.renderBufferDirect(U,null,P,W,R,null),R.onAfterShadow(i,R,w,U,P,W,null)}}const G=R.children;for(let P=0,Y=G.length;P<Y;P++)T(G[P],w,U,b,M)}function L(R){R.target.removeEventListener("dispose",L);for(const U in c){const b=c[U],M=R.target.uuid;M in b&&(b[M].dispose(),delete b[M])}}}function bp(i){function t(){let m=!1;const O=new he;let q=null;const nt=new he(0,0,0,0);return{setMask:function(lt){q!==lt&&!m&&(i.colorMask(lt,lt,lt,lt),q=lt)},setLocked:function(lt){m=lt},setClear:function(lt,Vt,Bt,jt,oe){oe===!0&&(lt*=jt,Vt*=jt,Bt*=jt),O.set(lt,Vt,Bt,jt),nt.equals(O)===!1&&(i.clearColor(lt,Vt,Bt,jt),nt.copy(O))},reset:function(){m=!1,q=null,nt.set(-1,0,0,0)}}}function e(){let m=!1,O=null,q=null,nt=null;return{setTest:function(lt){lt?ht(i.DEPTH_TEST):st(i.DEPTH_TEST)},setMask:function(lt){O!==lt&&!m&&(i.depthMask(lt),O=lt)},setFunc:function(lt){if(q!==lt){switch(lt){case Tl:i.depthFunc(i.NEVER);break;case wl:i.depthFunc(i.ALWAYS);break;case Rl:i.depthFunc(i.LESS);break;case hr:i.depthFunc(i.LEQUAL);break;case Cl:i.depthFunc(i.EQUAL);break;case Pl:i.depthFunc(i.GEQUAL);break;case Ll:i.depthFunc(i.GREATER);break;case Dl:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}q=lt}},setLocked:function(lt){m=lt},setClear:function(lt){nt!==lt&&(i.clearDepth(lt),nt=lt)},reset:function(){m=!1,O=null,q=null,nt=null}}}function n(){let m=!1,O=null,q=null,nt=null,lt=null,Vt=null,Bt=null,jt=null,oe=null;return{setTest:function(Yt){m||(Yt?ht(i.STENCIL_TEST):st(i.STENCIL_TEST))},setMask:function(Yt){O!==Yt&&!m&&(i.stencilMask(Yt),O=Yt)},setFunc:function(Yt,ee,ne){(q!==Yt||nt!==ee||lt!==ne)&&(i.stencilFunc(Yt,ee,ne),q=Yt,nt=ee,lt=ne)},setOp:function(Yt,ee,ne){(Vt!==Yt||Bt!==ee||jt!==ne)&&(i.stencilOp(Yt,ee,ne),Vt=Yt,Bt=ee,jt=ne)},setLocked:function(Yt){m=Yt},setClear:function(Yt){oe!==Yt&&(i.clearStencil(Yt),oe=Yt)},reset:function(){m=!1,O=null,q=null,nt=null,lt=null,Vt=null,Bt=null,jt=null,oe=null}}}const r=new t,s=new e,a=new n,o=new WeakMap,l=new WeakMap;let c={},h={},u=new WeakMap,f=[],g=null,x=!1,S=null,p=null,d=null,E=null,v=null,T=null,L=null,R=new Ft(0,0,0),w=0,U=!1,b=null,M=null,I=null,G=null,P=null;const Y=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let W=!1,K=0;const Z=i.getParameter(i.VERSION);Z.indexOf("WebGL")!==-1?(K=parseFloat(/^WebGL (\d)/.exec(Z)[1]),W=K>=1):Z.indexOf("OpenGL ES")!==-1&&(K=parseFloat(/^OpenGL ES (\d)/.exec(Z)[1]),W=K>=2);let V=null,tt={};const J=i.getParameter(i.SCISSOR_BOX),ut=i.getParameter(i.VIEWPORT),Nt=new he().fromArray(J),Gt=new he().fromArray(ut);function X(m,O,q,nt){const lt=new Uint8Array(4),Vt=i.createTexture();i.bindTexture(m,Vt),i.texParameteri(m,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(m,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Bt=0;Bt<q;Bt++)m===i.TEXTURE_3D||m===i.TEXTURE_2D_ARRAY?i.texImage3D(O,0,i.RGBA,1,1,nt,0,i.RGBA,i.UNSIGNED_BYTE,lt):i.texImage2D(O+Bt,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,lt);return Vt}const et={};et[i.TEXTURE_2D]=X(i.TEXTURE_2D,i.TEXTURE_2D,1),et[i.TEXTURE_CUBE_MAP]=X(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),et[i.TEXTURE_2D_ARRAY]=X(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),et[i.TEXTURE_3D]=X(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),s.setClear(1),a.setClear(0),ht(i.DEPTH_TEST),s.setFunc(hr),ct(!1),vt(Ns),ht(i.CULL_FACE),_t(dn);function ht(m){c[m]!==!0&&(i.enable(m),c[m]=!0)}function st(m){c[m]!==!1&&(i.disable(m),c[m]=!1)}function At(m,O){return h[m]!==O?(i.bindFramebuffer(m,O),h[m]=O,m===i.DRAW_FRAMEBUFFER&&(h[i.FRAMEBUFFER]=O),m===i.FRAMEBUFFER&&(h[i.DRAW_FRAMEBUFFER]=O),!0):!1}function Tt(m,O){let q=f,nt=!1;if(m){q=u.get(O),q===void 0&&(q=[],u.set(O,q));const lt=m.textures;if(q.length!==lt.length||q[0]!==i.COLOR_ATTACHMENT0){for(let Vt=0,Bt=lt.length;Vt<Bt;Vt++)q[Vt]=i.COLOR_ATTACHMENT0+Vt;q.length=lt.length,nt=!0}}else q[0]!==i.BACK&&(q[0]=i.BACK,nt=!0);nt&&i.drawBuffers(q)}function Ot(m){return g!==m?(i.useProgram(m),g=m,!0):!1}const N={[Tn]:i.FUNC_ADD,[cl]:i.FUNC_SUBTRACT,[hl]:i.FUNC_REVERSE_SUBTRACT};N[ul]=i.MIN,N[dl]=i.MAX;const Pt={[fl]:i.ZERO,[pl]:i.ONE,[ml]:i.SRC_COLOR,[us]:i.SRC_ALPHA,[Sl]:i.SRC_ALPHA_SATURATE,[xl]:i.DST_COLOR,[_l]:i.DST_ALPHA,[gl]:i.ONE_MINUS_SRC_COLOR,[ds]:i.ONE_MINUS_SRC_ALPHA,[Ml]:i.ONE_MINUS_DST_COLOR,[vl]:i.ONE_MINUS_DST_ALPHA,[El]:i.CONSTANT_COLOR,[yl]:i.ONE_MINUS_CONSTANT_COLOR,[bl]:i.CONSTANT_ALPHA,[Al]:i.ONE_MINUS_CONSTANT_ALPHA};function _t(m,O,q,nt,lt,Vt,Bt,jt,oe,Yt){if(m===dn){x===!0&&(st(i.BLEND),x=!1);return}if(x===!1&&(ht(i.BLEND),x=!0),m!==ll){if(m!==S||Yt!==U){if((p!==Tn||v!==Tn)&&(i.blendEquation(i.FUNC_ADD),p=Tn,v=Tn),Yt)switch(m){case ei:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Fs:i.blendFunc(i.ONE,i.ONE);break;case Os:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Bs:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",m);break}else switch(m){case ei:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Fs:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case Os:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Bs:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",m);break}d=null,E=null,T=null,L=null,R.set(0,0,0),w=0,S=m,U=Yt}return}lt=lt||O,Vt=Vt||q,Bt=Bt||nt,(O!==p||lt!==v)&&(i.blendEquationSeparate(N[O],N[lt]),p=O,v=lt),(q!==d||nt!==E||Vt!==T||Bt!==L)&&(i.blendFuncSeparate(Pt[q],Pt[nt],Pt[Vt],Pt[Bt]),d=q,E=nt,T=Vt,L=Bt),(jt.equals(R)===!1||oe!==w)&&(i.blendColor(jt.r,jt.g,jt.b,oe),R.copy(jt),w=oe),S=m,U=!1}function Lt(m,O){m.side===Oe?st(i.CULL_FACE):ht(i.CULL_FACE);let q=m.side===Se;O&&(q=!q),ct(q),m.blending===ei&&m.transparent===!1?_t(dn):_t(m.blending,m.blendEquation,m.blendSrc,m.blendDst,m.blendEquationAlpha,m.blendSrcAlpha,m.blendDstAlpha,m.blendColor,m.blendAlpha,m.premultipliedAlpha),s.setFunc(m.depthFunc),s.setTest(m.depthTest),s.setMask(m.depthWrite),r.setMask(m.colorWrite);const nt=m.stencilWrite;a.setTest(nt),nt&&(a.setMask(m.stencilWriteMask),a.setFunc(m.stencilFunc,m.stencilRef,m.stencilFuncMask),a.setOp(m.stencilFail,m.stencilZFail,m.stencilZPass)),_(m.polygonOffset,m.polygonOffsetFactor,m.polygonOffsetUnits),m.alphaToCoverage===!0?ht(i.SAMPLE_ALPHA_TO_COVERAGE):st(i.SAMPLE_ALPHA_TO_COVERAGE)}function ct(m){b!==m&&(m?i.frontFace(i.CW):i.frontFace(i.CCW),b=m)}function vt(m){m!==sl?(ht(i.CULL_FACE),m!==M&&(m===Ns?i.cullFace(i.BACK):m===al?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):st(i.CULL_FACE),M=m}function A(m){m!==I&&(W&&i.lineWidth(m),I=m)}function _(m,O,q){m?(ht(i.POLYGON_OFFSET_FILL),(G!==O||P!==q)&&(i.polygonOffset(O,q),G=O,P=q)):st(i.POLYGON_OFFSET_FILL)}function F(m){m?ht(i.SCISSOR_TEST):st(i.SCISSOR_TEST)}function k(m){m===void 0&&(m=i.TEXTURE0+Y-1),V!==m&&(i.activeTexture(m),V=m)}function $(m,O,q){q===void 0&&(V===null?q=i.TEXTURE0+Y-1:q=V);let nt=tt[q];nt===void 0&&(nt={type:void 0,texture:void 0},tt[q]=nt),(nt.type!==m||nt.texture!==O)&&(V!==q&&(i.activeTexture(q),V=q),i.bindTexture(m,O||et[m]),nt.type=m,nt.texture=O)}function j(){const m=tt[V];m!==void 0&&m.type!==void 0&&(i.bindTexture(m.type,null),m.type=void 0,m.texture=void 0)}function Mt(){try{i.compressedTexImage2D.apply(i,arguments)}catch(m){console.error("THREE.WebGLState:",m)}}function Q(){try{i.compressedTexImage3D.apply(i,arguments)}catch(m){console.error("THREE.WebGLState:",m)}}function gt(){try{i.texSubImage2D.apply(i,arguments)}catch(m){console.error("THREE.WebGLState:",m)}}function St(){try{i.texSubImage3D.apply(i,arguments)}catch(m){console.error("THREE.WebGLState:",m)}}function it(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(m){console.error("THREE.WebGLState:",m)}}function ot(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(m){console.error("THREE.WebGLState:",m)}}function yt(){try{i.texStorage2D.apply(i,arguments)}catch(m){console.error("THREE.WebGLState:",m)}}function dt(){try{i.texStorage3D.apply(i,arguments)}catch(m){console.error("THREE.WebGLState:",m)}}function ft(){try{i.texImage2D.apply(i,arguments)}catch(m){console.error("THREE.WebGLState:",m)}}function zt(){try{i.texImage3D.apply(i,arguments)}catch(m){console.error("THREE.WebGLState:",m)}}function Ht(m){Nt.equals(m)===!1&&(i.scissor(m.x,m.y,m.z,m.w),Nt.copy(m))}function Wt(m){Gt.equals(m)===!1&&(i.viewport(m.x,m.y,m.z,m.w),Gt.copy(m))}function kt(m,O){let q=l.get(O);q===void 0&&(q=new WeakMap,l.set(O,q));let nt=q.get(m);nt===void 0&&(nt=i.getUniformBlockIndex(O,m.name),q.set(m,nt))}function Xt(m,O){const nt=l.get(O).get(m);o.get(O)!==nt&&(i.uniformBlockBinding(O,nt,m.__bindingPointIndex),o.set(O,nt))}function pt(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),c={},V=null,tt={},h={},u=new WeakMap,f=[],g=null,x=!1,S=null,p=null,d=null,E=null,v=null,T=null,L=null,R=new Ft(0,0,0),w=0,U=!1,b=null,M=null,I=null,G=null,P=null,Nt.set(0,0,i.canvas.width,i.canvas.height),Gt.set(0,0,i.canvas.width,i.canvas.height),r.reset(),s.reset(),a.reset()}return{buffers:{color:r,depth:s,stencil:a},enable:ht,disable:st,bindFramebuffer:At,drawBuffers:Tt,useProgram:Ot,setBlending:_t,setMaterial:Lt,setFlipSided:ct,setCullFace:vt,setLineWidth:A,setPolygonOffset:_,setScissorTest:F,activeTexture:k,bindTexture:$,unbindTexture:j,compressedTexImage2D:Mt,compressedTexImage3D:Q,texImage2D:ft,texImage3D:zt,updateUBOMapping:kt,uniformBlockBinding:Xt,texStorage2D:yt,texStorage3D:dt,texSubImage2D:gt,texSubImage3D:St,compressedTexSubImage2D:it,compressedTexSubImage3D:ot,scissor:Ht,viewport:Wt,reset:pt}}function Ap(i,t,e,n,r,s,a){const o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new xt,h=new WeakMap;let u;const f=new WeakMap;let g=!1;try{g=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function x(A,_){return g?new OffscreenCanvas(A,_):Ti("canvas")}function S(A,_,F){let k=1;const $=vt(A);if(($.width>F||$.height>F)&&(k=F/Math.max($.width,$.height)),k<1)if(typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&A instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&A instanceof ImageBitmap||typeof VideoFrame<"u"&&A instanceof VideoFrame){const j=Math.floor(k*$.width),Mt=Math.floor(k*$.height);u===void 0&&(u=x(j,Mt));const Q=_?x(j,Mt):u;return Q.width=j,Q.height=Mt,Q.getContext("2d").drawImage(A,0,0,j,Mt),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+$.width+"x"+$.height+") to ("+j+"x"+Mt+")."),Q}else return"data"in A&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+$.width+"x"+$.height+")."),A;return A}function p(A){return A.generateMipmaps&&A.minFilter!==Te&&A.minFilter!==Ne}function d(A){i.generateMipmap(A)}function E(A,_,F,k,$=!1){if(A!==null){if(i[A]!==void 0)return i[A];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+A+"'")}let j=_;if(_===i.RED&&(F===i.FLOAT&&(j=i.R32F),F===i.HALF_FLOAT&&(j=i.R16F),F===i.UNSIGNED_BYTE&&(j=i.R8)),_===i.RED_INTEGER&&(F===i.UNSIGNED_BYTE&&(j=i.R8UI),F===i.UNSIGNED_SHORT&&(j=i.R16UI),F===i.UNSIGNED_INT&&(j=i.R32UI),F===i.BYTE&&(j=i.R8I),F===i.SHORT&&(j=i.R16I),F===i.INT&&(j=i.R32I)),_===i.RG&&(F===i.FLOAT&&(j=i.RG32F),F===i.HALF_FLOAT&&(j=i.RG16F),F===i.UNSIGNED_BYTE&&(j=i.RG8)),_===i.RG_INTEGER&&(F===i.UNSIGNED_BYTE&&(j=i.RG8UI),F===i.UNSIGNED_SHORT&&(j=i.RG16UI),F===i.UNSIGNED_INT&&(j=i.RG32UI),F===i.BYTE&&(j=i.RG8I),F===i.SHORT&&(j=i.RG16I),F===i.INT&&(j=i.RG32I)),_===i.RGB&&F===i.UNSIGNED_INT_5_9_9_9_REV&&(j=i.RGB9_E5),_===i.RGBA){const Mt=$?fr:qt.getTransfer(k);F===i.FLOAT&&(j=i.RGBA32F),F===i.HALF_FLOAT&&(j=i.RGBA16F),F===i.UNSIGNED_BYTE&&(j=Mt===$t?i.SRGB8_ALPHA8:i.RGBA8),F===i.UNSIGNED_SHORT_4_4_4_4&&(j=i.RGBA4),F===i.UNSIGNED_SHORT_5_5_5_1&&(j=i.RGB5_A1)}return(j===i.R16F||j===i.R32F||j===i.RG16F||j===i.RG32F||j===i.RGBA16F||j===i.RGBA32F)&&t.get("EXT_color_buffer_float"),j}function v(A,_){return p(A)===!0||A.isFramebufferTexture&&A.minFilter!==Te&&A.minFilter!==Ne?Math.log2(Math.max(_.width,_.height))+1:A.mipmaps!==void 0&&A.mipmaps.length>0?A.mipmaps.length:A.isCompressedTexture&&Array.isArray(A.image)?_.mipmaps.length:1}function T(A){const _=A.target;_.removeEventListener("dispose",T),R(_),_.isVideoTexture&&h.delete(_)}function L(A){const _=A.target;_.removeEventListener("dispose",L),U(_)}function R(A){const _=n.get(A);if(_.__webglInit===void 0)return;const F=A.source,k=f.get(F);if(k){const $=k[_.__cacheKey];$.usedTimes--,$.usedTimes===0&&w(A),Object.keys(k).length===0&&f.delete(F)}n.remove(A)}function w(A){const _=n.get(A);i.deleteTexture(_.__webglTexture);const F=A.source,k=f.get(F);delete k[_.__cacheKey],a.memory.textures--}function U(A){const _=n.get(A);if(A.depthTexture&&A.depthTexture.dispose(),A.isWebGLCubeRenderTarget)for(let k=0;k<6;k++){if(Array.isArray(_.__webglFramebuffer[k]))for(let $=0;$<_.__webglFramebuffer[k].length;$++)i.deleteFramebuffer(_.__webglFramebuffer[k][$]);else i.deleteFramebuffer(_.__webglFramebuffer[k]);_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer[k])}else{if(Array.isArray(_.__webglFramebuffer))for(let k=0;k<_.__webglFramebuffer.length;k++)i.deleteFramebuffer(_.__webglFramebuffer[k]);else i.deleteFramebuffer(_.__webglFramebuffer);if(_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer),_.__webglMultisampledFramebuffer&&i.deleteFramebuffer(_.__webglMultisampledFramebuffer),_.__webglColorRenderbuffer)for(let k=0;k<_.__webglColorRenderbuffer.length;k++)_.__webglColorRenderbuffer[k]&&i.deleteRenderbuffer(_.__webglColorRenderbuffer[k]);_.__webglDepthRenderbuffer&&i.deleteRenderbuffer(_.__webglDepthRenderbuffer)}const F=A.textures;for(let k=0,$=F.length;k<$;k++){const j=n.get(F[k]);j.__webglTexture&&(i.deleteTexture(j.__webglTexture),a.memory.textures--),n.remove(F[k])}n.remove(A)}let b=0;function M(){b=0}function I(){const A=b;return A>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+A+" texture units while this GPU supports only "+r.maxTextures),b+=1,A}function G(A){const _=[];return _.push(A.wrapS),_.push(A.wrapT),_.push(A.wrapR||0),_.push(A.magFilter),_.push(A.minFilter),_.push(A.anisotropy),_.push(A.internalFormat),_.push(A.format),_.push(A.type),_.push(A.generateMipmaps),_.push(A.premultiplyAlpha),_.push(A.flipY),_.push(A.unpackAlignment),_.push(A.colorSpace),_.join()}function P(A,_){const F=n.get(A);if(A.isVideoTexture&&Lt(A),A.isRenderTargetTexture===!1&&A.version>0&&F.__version!==A.version){const k=A.image;if(k===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(k.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Nt(F,A,_);return}}e.bindTexture(i.TEXTURE_2D,F.__webglTexture,i.TEXTURE0+_)}function Y(A,_){const F=n.get(A);if(A.version>0&&F.__version!==A.version){Nt(F,A,_);return}e.bindTexture(i.TEXTURE_2D_ARRAY,F.__webglTexture,i.TEXTURE0+_)}function W(A,_){const F=n.get(A);if(A.version>0&&F.__version!==A.version){Nt(F,A,_);return}e.bindTexture(i.TEXTURE_3D,F.__webglTexture,i.TEXTURE0+_)}function K(A,_){const F=n.get(A);if(A.version>0&&F.__version!==A.version){Gt(F,A,_);return}e.bindTexture(i.TEXTURE_CUBE_MAP,F.__webglTexture,i.TEXTURE0+_)}const Z={[ai]:i.REPEAT,[Rn]:i.CLAMP_TO_EDGE,[ps]:i.MIRRORED_REPEAT},V={[Te]:i.NEAREST,[kl]:i.NEAREST_MIPMAP_NEAREST,[Ui]:i.NEAREST_MIPMAP_LINEAR,[Ne]:i.LINEAR,[Rr]:i.LINEAR_MIPMAP_NEAREST,[Cn]:i.LINEAR_MIPMAP_LINEAR},tt={[nc]:i.NEVER,[lc]:i.ALWAYS,[ic]:i.LESS,[Io]:i.LEQUAL,[rc]:i.EQUAL,[oc]:i.GEQUAL,[sc]:i.GREATER,[ac]:i.NOTEQUAL};function J(A,_){if(_.type===un&&t.has("OES_texture_float_linear")===!1&&(_.magFilter===Ne||_.magFilter===Rr||_.magFilter===Ui||_.magFilter===Cn||_.minFilter===Ne||_.minFilter===Rr||_.minFilter===Ui||_.minFilter===Cn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(A,i.TEXTURE_WRAP_S,Z[_.wrapS]),i.texParameteri(A,i.TEXTURE_WRAP_T,Z[_.wrapT]),(A===i.TEXTURE_3D||A===i.TEXTURE_2D_ARRAY)&&i.texParameteri(A,i.TEXTURE_WRAP_R,Z[_.wrapR]),i.texParameteri(A,i.TEXTURE_MAG_FILTER,V[_.magFilter]),i.texParameteri(A,i.TEXTURE_MIN_FILTER,V[_.minFilter]),_.compareFunction&&(i.texParameteri(A,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(A,i.TEXTURE_COMPARE_FUNC,tt[_.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(_.magFilter===Te||_.minFilter!==Ui&&_.minFilter!==Cn||_.type===un&&t.has("OES_texture_float_linear")===!1)return;if(_.anisotropy>1||n.get(_).__currentAnisotropy){const F=t.get("EXT_texture_filter_anisotropic");i.texParameterf(A,F.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,r.getMaxAnisotropy())),n.get(_).__currentAnisotropy=_.anisotropy}}}function ut(A,_){let F=!1;A.__webglInit===void 0&&(A.__webglInit=!0,_.addEventListener("dispose",T));const k=_.source;let $=f.get(k);$===void 0&&($={},f.set(k,$));const j=G(_);if(j!==A.__cacheKey){$[j]===void 0&&($[j]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,F=!0),$[j].usedTimes++;const Mt=$[A.__cacheKey];Mt!==void 0&&($[A.__cacheKey].usedTimes--,Mt.usedTimes===0&&w(_)),A.__cacheKey=j,A.__webglTexture=$[j].texture}return F}function Nt(A,_,F){let k=i.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&(k=i.TEXTURE_2D_ARRAY),_.isData3DTexture&&(k=i.TEXTURE_3D);const $=ut(A,_),j=_.source;e.bindTexture(k,A.__webglTexture,i.TEXTURE0+F);const Mt=n.get(j);if(j.version!==Mt.__version||$===!0){e.activeTexture(i.TEXTURE0+F);const Q=qt.getPrimaries(qt.workingColorSpace),gt=_.colorSpace===hn?null:qt.getPrimaries(_.colorSpace),St=_.colorSpace===hn||Q===gt?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,St);let it=S(_.image,!1,r.maxTextureSize);it=ct(_,it);const ot=s.convert(_.format,_.colorSpace),yt=s.convert(_.type);let dt=E(_.internalFormat,ot,yt,_.colorSpace,_.isVideoTexture);J(k,_);let ft;const zt=_.mipmaps,Ht=_.isVideoTexture!==!0&&dt!==Do,Wt=Mt.__version===void 0||$===!0,kt=j.dataReady,Xt=v(_,it);if(_.isDepthTexture)dt=i.DEPTH_COMPONENT16,_.type===un?dt=i.DEPTH_COMPONENT32F:_.type===oi?dt=i.DEPTH_COMPONENT24:_.type===Ri&&(dt=i.DEPTH24_STENCIL8),Wt&&(Ht?e.texStorage2D(i.TEXTURE_2D,1,dt,it.width,it.height):e.texImage2D(i.TEXTURE_2D,0,dt,it.width,it.height,0,ot,yt,null));else if(_.isDataTexture)if(zt.length>0){Ht&&Wt&&e.texStorage2D(i.TEXTURE_2D,Xt,dt,zt[0].width,zt[0].height);for(let pt=0,m=zt.length;pt<m;pt++)ft=zt[pt],Ht?kt&&e.texSubImage2D(i.TEXTURE_2D,pt,0,0,ft.width,ft.height,ot,yt,ft.data):e.texImage2D(i.TEXTURE_2D,pt,dt,ft.width,ft.height,0,ot,yt,ft.data);_.generateMipmaps=!1}else Ht?(Wt&&e.texStorage2D(i.TEXTURE_2D,Xt,dt,it.width,it.height),kt&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,it.width,it.height,ot,yt,it.data)):e.texImage2D(i.TEXTURE_2D,0,dt,it.width,it.height,0,ot,yt,it.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){Ht&&Wt&&e.texStorage3D(i.TEXTURE_2D_ARRAY,Xt,dt,zt[0].width,zt[0].height,it.depth);for(let pt=0,m=zt.length;pt<m;pt++)ft=zt[pt],_.format!==ze?ot!==null?Ht?kt&&e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,pt,0,0,0,ft.width,ft.height,it.depth,ot,ft.data,0,0):e.compressedTexImage3D(i.TEXTURE_2D_ARRAY,pt,dt,ft.width,ft.height,it.depth,0,ft.data,0,0):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ht?kt&&e.texSubImage3D(i.TEXTURE_2D_ARRAY,pt,0,0,0,ft.width,ft.height,it.depth,ot,yt,ft.data):e.texImage3D(i.TEXTURE_2D_ARRAY,pt,dt,ft.width,ft.height,it.depth,0,ot,yt,ft.data)}else{Ht&&Wt&&e.texStorage2D(i.TEXTURE_2D,Xt,dt,zt[0].width,zt[0].height);for(let pt=0,m=zt.length;pt<m;pt++)ft=zt[pt],_.format!==ze?ot!==null?Ht?kt&&e.compressedTexSubImage2D(i.TEXTURE_2D,pt,0,0,ft.width,ft.height,ot,ft.data):e.compressedTexImage2D(i.TEXTURE_2D,pt,dt,ft.width,ft.height,0,ft.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ht?kt&&e.texSubImage2D(i.TEXTURE_2D,pt,0,0,ft.width,ft.height,ot,yt,ft.data):e.texImage2D(i.TEXTURE_2D,pt,dt,ft.width,ft.height,0,ot,yt,ft.data)}else if(_.isDataArrayTexture)Ht?(Wt&&e.texStorage3D(i.TEXTURE_2D_ARRAY,Xt,dt,it.width,it.height,it.depth),kt&&e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,it.width,it.height,it.depth,ot,yt,it.data)):e.texImage3D(i.TEXTURE_2D_ARRAY,0,dt,it.width,it.height,it.depth,0,ot,yt,it.data);else if(_.isData3DTexture)Ht?(Wt&&e.texStorage3D(i.TEXTURE_3D,Xt,dt,it.width,it.height,it.depth),kt&&e.texSubImage3D(i.TEXTURE_3D,0,0,0,0,it.width,it.height,it.depth,ot,yt,it.data)):e.texImage3D(i.TEXTURE_3D,0,dt,it.width,it.height,it.depth,0,ot,yt,it.data);else if(_.isFramebufferTexture){if(Wt)if(Ht)e.texStorage2D(i.TEXTURE_2D,Xt,dt,it.width,it.height);else{let pt=it.width,m=it.height;for(let O=0;O<Xt;O++)e.texImage2D(i.TEXTURE_2D,O,dt,pt,m,0,ot,yt,null),pt>>=1,m>>=1}}else if(zt.length>0){if(Ht&&Wt){const pt=vt(zt[0]);e.texStorage2D(i.TEXTURE_2D,Xt,dt,pt.width,pt.height)}for(let pt=0,m=zt.length;pt<m;pt++)ft=zt[pt],Ht?kt&&e.texSubImage2D(i.TEXTURE_2D,pt,0,0,ot,yt,ft):e.texImage2D(i.TEXTURE_2D,pt,dt,ot,yt,ft);_.generateMipmaps=!1}else if(Ht){if(Wt){const pt=vt(it);e.texStorage2D(i.TEXTURE_2D,Xt,dt,pt.width,pt.height)}kt&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,ot,yt,it)}else e.texImage2D(i.TEXTURE_2D,0,dt,ot,yt,it);p(_)&&d(k),Mt.__version=j.version,_.onUpdate&&_.onUpdate(_)}A.__version=_.version}function Gt(A,_,F){if(_.image.length!==6)return;const k=ut(A,_),$=_.source;e.bindTexture(i.TEXTURE_CUBE_MAP,A.__webglTexture,i.TEXTURE0+F);const j=n.get($);if($.version!==j.__version||k===!0){e.activeTexture(i.TEXTURE0+F);const Mt=qt.getPrimaries(qt.workingColorSpace),Q=_.colorSpace===hn?null:qt.getPrimaries(_.colorSpace),gt=_.colorSpace===hn||Mt===Q?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,gt);const St=_.isCompressedTexture||_.image[0].isCompressedTexture,it=_.image[0]&&_.image[0].isDataTexture,ot=[];for(let m=0;m<6;m++)!St&&!it?ot[m]=S(_.image[m],!0,r.maxCubemapSize):ot[m]=it?_.image[m].image:_.image[m],ot[m]=ct(_,ot[m]);const yt=ot[0],dt=s.convert(_.format,_.colorSpace),ft=s.convert(_.type),zt=E(_.internalFormat,dt,ft,_.colorSpace),Ht=_.isVideoTexture!==!0,Wt=j.__version===void 0||k===!0,kt=$.dataReady;let Xt=v(_,yt);J(i.TEXTURE_CUBE_MAP,_);let pt;if(St){Ht&&Wt&&e.texStorage2D(i.TEXTURE_CUBE_MAP,Xt,zt,yt.width,yt.height);for(let m=0;m<6;m++){pt=ot[m].mipmaps;for(let O=0;O<pt.length;O++){const q=pt[O];_.format!==ze?dt!==null?Ht?kt&&e.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+m,O,0,0,q.width,q.height,dt,q.data):e.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+m,O,zt,q.width,q.height,0,q.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Ht?kt&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+m,O,0,0,q.width,q.height,dt,ft,q.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+m,O,zt,q.width,q.height,0,dt,ft,q.data)}}}else{if(pt=_.mipmaps,Ht&&Wt){pt.length>0&&Xt++;const m=vt(ot[0]);e.texStorage2D(i.TEXTURE_CUBE_MAP,Xt,zt,m.width,m.height)}for(let m=0;m<6;m++)if(it){Ht?kt&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+m,0,0,0,ot[m].width,ot[m].height,dt,ft,ot[m].data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+m,0,zt,ot[m].width,ot[m].height,0,dt,ft,ot[m].data);for(let O=0;O<pt.length;O++){const nt=pt[O].image[m].image;Ht?kt&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+m,O+1,0,0,nt.width,nt.height,dt,ft,nt.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+m,O+1,zt,nt.width,nt.height,0,dt,ft,nt.data)}}else{Ht?kt&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+m,0,0,0,dt,ft,ot[m]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+m,0,zt,dt,ft,ot[m]);for(let O=0;O<pt.length;O++){const q=pt[O];Ht?kt&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+m,O+1,0,0,dt,ft,q.image[m]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+m,O+1,zt,dt,ft,q.image[m])}}}p(_)&&d(i.TEXTURE_CUBE_MAP),j.__version=$.version,_.onUpdate&&_.onUpdate(_)}A.__version=_.version}function X(A,_,F,k,$,j){const Mt=s.convert(F.format,F.colorSpace),Q=s.convert(F.type),gt=E(F.internalFormat,Mt,Q,F.colorSpace);if(!n.get(_).__hasExternalTextures){const it=Math.max(1,_.width>>j),ot=Math.max(1,_.height>>j);$===i.TEXTURE_3D||$===i.TEXTURE_2D_ARRAY?e.texImage3D($,j,gt,it,ot,_.depth,0,Mt,Q,null):e.texImage2D($,j,gt,it,ot,0,Mt,Q,null)}e.bindFramebuffer(i.FRAMEBUFFER,A),_t(_)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,k,$,n.get(F).__webglTexture,0,Pt(_)):($===i.TEXTURE_2D||$>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&$<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,k,$,n.get(F).__webglTexture,j),e.bindFramebuffer(i.FRAMEBUFFER,null)}function et(A,_,F){if(i.bindRenderbuffer(i.RENDERBUFFER,A),_.depthBuffer&&!_.stencilBuffer){let k=i.DEPTH_COMPONENT24;if(F||_t(_)){const $=_.depthTexture;$&&$.isDepthTexture&&($.type===un?k=i.DEPTH_COMPONENT32F:$.type===oi&&(k=i.DEPTH_COMPONENT24));const j=Pt(_);_t(_)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,j,k,_.width,_.height):i.renderbufferStorageMultisample(i.RENDERBUFFER,j,k,_.width,_.height)}else i.renderbufferStorage(i.RENDERBUFFER,k,_.width,_.height);i.framebufferRenderbuffer(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.RENDERBUFFER,A)}else if(_.depthBuffer&&_.stencilBuffer){const k=Pt(_);F&&_t(_)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,k,i.DEPTH24_STENCIL8,_.width,_.height):_t(_)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,k,i.DEPTH24_STENCIL8,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,i.DEPTH_STENCIL,_.width,_.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.RENDERBUFFER,A)}else{const k=_.textures;for(let $=0;$<k.length;$++){const j=k[$],Mt=s.convert(j.format,j.colorSpace),Q=s.convert(j.type),gt=E(j.internalFormat,Mt,Q,j.colorSpace),St=Pt(_);F&&_t(_)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,St,gt,_.width,_.height):_t(_)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,St,gt,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,gt,_.width,_.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function ht(A,_){if(_&&_.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(e.bindFramebuffer(i.FRAMEBUFFER,A),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!n.get(_.depthTexture).__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),P(_.depthTexture,0);const k=n.get(_.depthTexture).__webglTexture,$=Pt(_);if(_.depthTexture.format===ni)_t(_)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,k,0,$):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,k,0);else if(_.depthTexture.format===bi)_t(_)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,k,0,$):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,k,0);else throw new Error("Unknown depthTexture format")}function st(A){const _=n.get(A),F=A.isWebGLCubeRenderTarget===!0;if(A.depthTexture&&!_.__autoAllocateDepthBuffer){if(F)throw new Error("target.depthTexture not supported in Cube render targets");ht(_.__webglFramebuffer,A)}else if(F){_.__webglDepthbuffer=[];for(let k=0;k<6;k++)e.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[k]),_.__webglDepthbuffer[k]=i.createRenderbuffer(),et(_.__webglDepthbuffer[k],A,!1)}else e.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer=i.createRenderbuffer(),et(_.__webglDepthbuffer,A,!1);e.bindFramebuffer(i.FRAMEBUFFER,null)}function At(A,_,F){const k=n.get(A);_!==void 0&&X(k.__webglFramebuffer,A,A.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),F!==void 0&&st(A)}function Tt(A){const _=A.texture,F=n.get(A),k=n.get(_);A.addEventListener("dispose",L);const $=A.textures,j=A.isWebGLCubeRenderTarget===!0,Mt=$.length>1;if(Mt||(k.__webglTexture===void 0&&(k.__webglTexture=i.createTexture()),k.__version=_.version,a.memory.textures++),j){F.__webglFramebuffer=[];for(let Q=0;Q<6;Q++)if(_.mipmaps&&_.mipmaps.length>0){F.__webglFramebuffer[Q]=[];for(let gt=0;gt<_.mipmaps.length;gt++)F.__webglFramebuffer[Q][gt]=i.createFramebuffer()}else F.__webglFramebuffer[Q]=i.createFramebuffer()}else{if(_.mipmaps&&_.mipmaps.length>0){F.__webglFramebuffer=[];for(let Q=0;Q<_.mipmaps.length;Q++)F.__webglFramebuffer[Q]=i.createFramebuffer()}else F.__webglFramebuffer=i.createFramebuffer();if(Mt)for(let Q=0,gt=$.length;Q<gt;Q++){const St=n.get($[Q]);St.__webglTexture===void 0&&(St.__webglTexture=i.createTexture(),a.memory.textures++)}if(A.samples>0&&_t(A)===!1){F.__webglMultisampledFramebuffer=i.createFramebuffer(),F.__webglColorRenderbuffer=[],e.bindFramebuffer(i.FRAMEBUFFER,F.__webglMultisampledFramebuffer);for(let Q=0;Q<$.length;Q++){const gt=$[Q];F.__webglColorRenderbuffer[Q]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,F.__webglColorRenderbuffer[Q]);const St=s.convert(gt.format,gt.colorSpace),it=s.convert(gt.type),ot=E(gt.internalFormat,St,it,gt.colorSpace,A.isXRRenderTarget===!0),yt=Pt(A);i.renderbufferStorageMultisample(i.RENDERBUFFER,yt,ot,A.width,A.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Q,i.RENDERBUFFER,F.__webglColorRenderbuffer[Q])}i.bindRenderbuffer(i.RENDERBUFFER,null),A.depthBuffer&&(F.__webglDepthRenderbuffer=i.createRenderbuffer(),et(F.__webglDepthRenderbuffer,A,!0)),e.bindFramebuffer(i.FRAMEBUFFER,null)}}if(j){e.bindTexture(i.TEXTURE_CUBE_MAP,k.__webglTexture),J(i.TEXTURE_CUBE_MAP,_);for(let Q=0;Q<6;Q++)if(_.mipmaps&&_.mipmaps.length>0)for(let gt=0;gt<_.mipmaps.length;gt++)X(F.__webglFramebuffer[Q][gt],A,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,gt);else X(F.__webglFramebuffer[Q],A,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0);p(_)&&d(i.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(Mt){for(let Q=0,gt=$.length;Q<gt;Q++){const St=$[Q],it=n.get(St);e.bindTexture(i.TEXTURE_2D,it.__webglTexture),J(i.TEXTURE_2D,St),X(F.__webglFramebuffer,A,St,i.COLOR_ATTACHMENT0+Q,i.TEXTURE_2D,0),p(St)&&d(i.TEXTURE_2D)}e.unbindTexture()}else{let Q=i.TEXTURE_2D;if((A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(Q=A.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(Q,k.__webglTexture),J(Q,_),_.mipmaps&&_.mipmaps.length>0)for(let gt=0;gt<_.mipmaps.length;gt++)X(F.__webglFramebuffer[gt],A,_,i.COLOR_ATTACHMENT0,Q,gt);else X(F.__webglFramebuffer,A,_,i.COLOR_ATTACHMENT0,Q,0);p(_)&&d(Q),e.unbindTexture()}A.depthBuffer&&st(A)}function Ot(A){const _=A.textures;for(let F=0,k=_.length;F<k;F++){const $=_[F];if(p($)){const j=A.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:i.TEXTURE_2D,Mt=n.get($).__webglTexture;e.bindTexture(j,Mt),d(j),e.unbindTexture()}}}function N(A){if(A.samples>0&&_t(A)===!1){const _=A.textures,F=A.width,k=A.height;let $=i.COLOR_BUFFER_BIT;const j=[],Mt=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Q=n.get(A),gt=_.length>1;if(gt)for(let St=0;St<_.length;St++)e.bindFramebuffer(i.FRAMEBUFFER,Q.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+St,i.RENDERBUFFER,null),e.bindFramebuffer(i.FRAMEBUFFER,Q.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+St,i.TEXTURE_2D,null,0);e.bindFramebuffer(i.READ_FRAMEBUFFER,Q.__webglMultisampledFramebuffer),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,Q.__webglFramebuffer);for(let St=0;St<_.length;St++){j.push(i.COLOR_ATTACHMENT0+St),A.depthBuffer&&j.push(Mt);const it=Q.__ignoreDepthValues!==void 0?Q.__ignoreDepthValues:!1;if(it===!1&&(A.depthBuffer&&($|=i.DEPTH_BUFFER_BIT),A.stencilBuffer&&Q.__isTransmissionRenderTarget!==!0&&($|=i.STENCIL_BUFFER_BIT)),gt&&i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,Q.__webglColorRenderbuffer[St]),it===!0&&(i.invalidateFramebuffer(i.READ_FRAMEBUFFER,[Mt]),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[Mt])),gt){const ot=n.get(_[St]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,ot,0)}i.blitFramebuffer(0,0,F,k,0,0,F,k,$,i.NEAREST),l&&i.invalidateFramebuffer(i.READ_FRAMEBUFFER,j)}if(e.bindFramebuffer(i.READ_FRAMEBUFFER,null),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),gt)for(let St=0;St<_.length;St++){e.bindFramebuffer(i.FRAMEBUFFER,Q.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+St,i.RENDERBUFFER,Q.__webglColorRenderbuffer[St]);const it=n.get(_[St]).__webglTexture;e.bindFramebuffer(i.FRAMEBUFFER,Q.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+St,i.TEXTURE_2D,it,0)}e.bindFramebuffer(i.DRAW_FRAMEBUFFER,Q.__webglMultisampledFramebuffer)}}function Pt(A){return Math.min(r.maxSamples,A.samples)}function _t(A){const _=n.get(A);return A.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function Lt(A){const _=a.render.frame;h.get(A)!==_&&(h.set(A,_),A.update())}function ct(A,_){const F=A.colorSpace,k=A.format,$=A.type;return A.isCompressedTexture===!0||A.isVideoTexture===!0||F!==gn&&F!==hn&&(qt.getTransfer(F)===$t?(k!==ze||$!==pn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",F)),_}function vt(A){return typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement?(c.width=A.naturalWidth||A.width,c.height=A.naturalHeight||A.height):typeof VideoFrame<"u"&&A instanceof VideoFrame?(c.width=A.displayWidth,c.height=A.displayHeight):(c.width=A.width,c.height=A.height),c}this.allocateTextureUnit=I,this.resetTextureUnits=M,this.setTexture2D=P,this.setTexture2DArray=Y,this.setTexture3D=W,this.setTextureCube=K,this.rebindTextures=At,this.setupRenderTarget=Tt,this.updateRenderTargetMipmap=Ot,this.updateMultisampleRenderTarget=N,this.setupDepthRenderbuffer=st,this.setupFrameBufferTexture=X,this.useMultisampledRTT=_t}function Tp(i,t){function e(n,r=hn){let s;const a=qt.getTransfer(r);if(n===pn)return i.UNSIGNED_BYTE;if(n===wo)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Ro)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Xl)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===Gl)return i.BYTE;if(n===Wl)return i.SHORT;if(n===Ao)return i.UNSIGNED_SHORT;if(n===To)return i.INT;if(n===oi)return i.UNSIGNED_INT;if(n===un)return i.FLOAT;if(n===dr)return i.HALF_FLOAT;if(n===Yl)return i.ALPHA;if(n===ql)return i.RGB;if(n===ze)return i.RGBA;if(n===$l)return i.LUMINANCE;if(n===jl)return i.LUMINANCE_ALPHA;if(n===ni)return i.DEPTH_COMPONENT;if(n===bi)return i.DEPTH_STENCIL;if(n===Kl)return i.RED;if(n===Co)return i.RED_INTEGER;if(n===Zl)return i.RG;if(n===Po)return i.RG_INTEGER;if(n===Lo)return i.RGBA_INTEGER;if(n===Cr||n===Pr||n===Lr||n===Dr)if(a===$t)if(s=t.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===Cr)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Pr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Lr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Dr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=t.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===Cr)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Pr)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Lr)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Dr)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===zs||n===Hs||n===Vs||n===ks)if(s=t.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===zs)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Hs)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Vs)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===ks)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Do)return s=t.get("WEBGL_compressed_texture_etc1"),s!==null?s.COMPRESSED_RGB_ETC1_WEBGL:null;if(n===Gs||n===Ws)if(s=t.get("WEBGL_compressed_texture_etc"),s!==null){if(n===Gs)return a===$t?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===Ws)return a===$t?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===Xs||n===Ys||n===qs||n===$s||n===js||n===Ks||n===Zs||n===Js||n===Qs||n===ta||n===ea||n===na||n===ia||n===ra)if(s=t.get("WEBGL_compressed_texture_astc"),s!==null){if(n===Xs)return a===$t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Ys)return a===$t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===qs)return a===$t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===$s)return a===$t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===js)return a===$t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Ks)return a===$t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Zs)return a===$t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Js)return a===$t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Qs)return a===$t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===ta)return a===$t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===ea)return a===$t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===na)return a===$t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===ia)return a===$t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===ra)return a===$t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Ur||n===sa||n===aa)if(s=t.get("EXT_texture_compression_bptc"),s!==null){if(n===Ur)return a===$t?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===sa)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===aa)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Jl||n===oa||n===la||n===ca)if(s=t.get("EXT_texture_compression_rgtc"),s!==null){if(n===Ur)return s.COMPRESSED_RED_RGTC1_EXT;if(n===oa)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===la)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===ca)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Ri?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:e}}class wp extends Le{constructor(t=[]){super(),this.isArrayCamera=!0,this.cameras=t}}class xi extends re{constructor(){super(),this.isGroup=!0,this.type="Group"}}const Rp={type:"move"};class rs{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new xi,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new xi,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new C,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new C),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new xi,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new C,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new C),this._grip}dispatchEvent(t){return this._targetRay!==null&&this._targetRay.dispatchEvent(t),this._grip!==null&&this._grip.dispatchEvent(t),this._hand!==null&&this._hand.dispatchEvent(t),this}connect(t){if(t&&t.hand){const e=this._hand;if(e)for(const n of t.hand.values())this._getHandJoint(e,n)}return this.dispatchEvent({type:"connected",data:t}),this}disconnect(t){return this.dispatchEvent({type:"disconnected",data:t}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(t,e,n){let r=null,s=null,a=null;const o=this._targetRay,l=this._grip,c=this._hand;if(t&&e.session.visibilityState!=="visible-blurred"){if(c&&t.hand){a=!0;for(const S of t.hand.values()){const p=e.getJointPose(S,n),d=this._getHandJoint(c,S);p!==null&&(d.matrix.fromArray(p.transform.matrix),d.matrix.decompose(d.position,d.rotation,d.scale),d.matrixWorldNeedsUpdate=!0,d.jointRadius=p.radius),d.visible=p!==null}const h=c.joints["index-finger-tip"],u=c.joints["thumb-tip"],f=h.position.distanceTo(u.position),g=.02,x=.005;c.inputState.pinching&&f>g+x?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:t.handedness,target:this})):!c.inputState.pinching&&f<=g-x&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:t.handedness,target:this}))}else l!==null&&t.gripSpace&&(s=e.getPose(t.gripSpace,n),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));o!==null&&(r=e.getPose(t.targetRaySpace,n),r===null&&s!==null&&(r=s),r!==null&&(o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.rotation,o.scale),o.matrixWorldNeedsUpdate=!0,r.linearVelocity?(o.hasLinearVelocity=!0,o.linearVelocity.copy(r.linearVelocity)):o.hasLinearVelocity=!1,r.angularVelocity?(o.hasAngularVelocity=!0,o.angularVelocity.copy(r.angularVelocity)):o.hasAngularVelocity=!1,this.dispatchEvent(Rp)))}return o!==null&&(o.visible=r!==null),l!==null&&(l.visible=s!==null),c!==null&&(c.visible=a!==null),this}_getHandJoint(t,e){if(t.joints[e.jointName]===void 0){const n=new xi;n.matrixAutoUpdate=!1,n.visible=!1,t.joints[e.jointName]=n,t.add(n)}return t.joints[e.jointName]}}const Cp=`
void main() {
...
}`;function mm(i){const t=document.createElement("style");t.innerHTML=i;const e=document.querySelector("head link[rel=stylesheet], head style");e?document.head.insertBefore(t,e):document.head.appendChild(t)}let Eo=!1;class Cs{constructor({parent:t,autoPlace:e=t===void 0,container:n,width:r,title:s="Controls",closeFolders:a=!1,injectStyles:o=!0,touchStyles:l=!0}={}){if(this.parent=t,this.root=t?t.root:this,this.children=[],this.controllers=[],this.folders=[],this._closed=!1,this._hidden=!1,this.domElement=document.createElement("div"),this.domElement.classList.add("lil-gui"),this.$title=document.createElement("div"),this.$title.classList.add("title"),this.$title.setAttribute("role","button"),this.$title.setAttribute("aria-expanded",!0),this.$title.setAttribute("tabindex",0),this.$title.addEventListener("click",()=>this.openAnimated(this._closed)),this.$title.addEventListener("keydown",c=>{(c.code==="Enter"||c.code==="Space")&&(c.preventDefault(),this.$title.click())}),this.$title.addEventListener("touchstart",()=>{},{passive:!0}),this.$children=document.createElement("div"),this.$children.classList.add("children"),this.domElement.appendChild(this.$title),this.domElement.appendChild(this.$children),this.title(s),this.parent){this.parent.children.push(this),this.parent.folders.push(this),this.parent.$children.appendChild(this.domElement);return}this.domElement.classList.add("root"),l&&this.domElement.classList.add("allow-touch-styles"),!Eo&&o&&(mm(pm),Eo=!0),n?n.appendChild(this.domElement):e&&(this.domElement.classList.add("autoPlace"),document.body.appendChild(this.domElement)),r&&this.domElement.style.setProperty("--width",r+"px"),this._closeFolders=a}add(t,e,n,r,s){if(Object(n)===n)return new dm(this,t,e,n);const a=t[e];switch(typeof a){case"number":return new um(this,t,e,n,r,s);case"boolean":return new rm(this,t,e);case"string":return new fm(this,t,e);case"function":return new hs(this,t,e)}console.error(`gui.add failed
	property:`,e,`
	object:`,t,`
	value:`,a)}addColor(t,e,n=1){return new hm(this,t,e,n)}addFolder(t){const e=new Cs({parent:this,title:t});return this.root._closeFolders&&e.close(),e}load(t,e=!0){return t.controllers&&this.controllers.forEach(n=>{n instanceof hs||n._name in t.controllers&&n.load(t.controllers[n._name])}),e&&t.folders&&this.folders.forEach(n=>{n._title in t.folders&&n.load(t.folders[n._title])}),this}save(t=!0){const e={controllers:{},folders:{}};return this.controllers.forEach(n=>{if(!(n instanceof hs)){if(n._name in e.controllers)throw new Error(`Cannot save GUI with duplicate property "${n._name}"`);e.controllers[n._name]=n.save()}}),t&&this.folders.forEach(n=>{if(n._title in e.folders)throw new Error(`Cannot save GUI with duplicate folder "${n._title}"`);e.folders[n._title]=n.save()}),e}open(t=!0){return this._setClosed(!t),this.$title.setAttribute("aria-expanded",!this._closed),this.domElement.classList.toggle("closed",this._closed),this}close(){return this.open(!1)}_setClosed(t){this._closed!==t&&(this._closed=t,this._callOnOpenClose(this))}show(t=!0){return this._hidden=!t,this.domElement.style.display=this._hidden?"none":"",this}hide(){return this.show(!1)}openAnimated(t=!0){return this._setClosed(!t),this.$title.setAttribute("aria-expanded",!this._closed),requestAnimationFrame(()=>{const e=this.$children.clientHeight;this.$children.style.height=e+"px",this.domElement.classList.add("transition");const n=s=>{s.target===this.$children&&(this.$children.style.height="",this.domElement.classList.remove("transition"),this.$children.removeEventListener("transitionend",n))};this.$children.addEventListener("transitionend",n);const r=t?this.$children.scrollHeight:0;this.domElement.classList.toggle("closed",!t),requestAnimationFrame(()=>{this.$children.style.height=r+"px"})}),this}title(t){return this._title=t,this.$title.textContent=t,this}reset(t=!0){return(t?this.controllersRecursive():this.controllers).forEach(n=>n.reset()),this}onChange(t){return this._onChange=t,this}_callOnChange(t){this.parent&&this.parent._callOnChange(t),this._onChange!==void 0&&this._onChange.call(this,{object:t.object,property:t.property,value:t.getValue(),controller:t})}onFinishChange(t){return this._onFinishChange=t,this}_callOnFinishChange(t){this.parent&&this.parent._callOnFinishChange(t),this._onFinishChange!==void 0&&this._onFinishChange.call(this,{object:t.object,property:t.property,value:t.getValue(),controller:t})}onOpenClose(t){return this._onOpenClose=t,this}_callOnOpenClose(t){this.parent&&this.parent._callOnOpenClose(t),this._onOpenClose!==void 0&&this._onOpenClose.call(this,t)}destroy(){this.parent&&(this.parent.children.splice(this.parent.children.indexOf(this),1),this.parent.folders.splice(this.parent.folders.indexOf(this),1)),this.domElement.parentElement&&this.domElement.parentElement.removeChild(this.domElement),Array.from(this.children).forEach(t=>t.destroy())}controllersRecursive(){let t=Array.from(this.controllers);return this.folders.forEach(e=>{t=t.concat(e.controllersRecursive())}),t}foldersRecursive(){let t=Array.from(this.folders);return this.folders.forEach(e=>{t=t.concat(e.foldersRecursive())}),t}}class or{constructor(t,e){this.object=t,this.prop=e}get value(){return"#${this.object[this.prop].getHexString()}"}set value(t){this.object[this.prop].set(t)}}function gm(){const i=document.querySelector("#c"),t=new Fp({antialias:!0,canvas:i}),e=45,n=2,r=.1,s=100,a=new Le(e,n,r,s);a.position.set(0,10,20);const o=new jp(a,i);o.target.set(0,5,0),o.update();const l=40,h=new cr().load("checker.png");h.wrapS=ai,h.wrapT=ai,h.magFilter=Te,h.colorSpace=_e;const u=l/2;h.repeat.set(u,u);const f=new Li(l,l),g=new vr({map:h,side:void 0}),x=new ve(f,g);x.rotation.x=Math.PI*-.5;const p=new cr().load("falcon.jpeg");p.colorSpace=_e;const d=16763955,E=1,v=new Wp(d,E);v.position.set(0,10,0);const T=new qp(v),L=16777215,R=.1,w=new Xp(L,R),U=11657727,b=12155424,M=1,I=new Vp(U,b,M);function G(Lt,ct,vt,A){const _=Lt.addFolder(vt);_.add(ct,"x",-10,10).onChange(A),_.add(ct,"y",0,10).onChange(A),_.add(ct,"z",-10,10).onChange(A),_.open()}function P(){v.target.updateMatrixWorld(),T.update()}const Y=new Cs;Y.addColor(new or(v,"color"),"value").name("Directional Light Color"),Y.add(v,"intensity",0,1,.01),G(Y,v.position,"position",P),G(Y,v.target.position,"position",P),Y.addColor(new or(w,"color"),"value").name("Ambient Light Color"),Y.add(w,"intensity",0,1,.01),Y.addColor(new or(I,"color"),"value").name("skyColor"),Y.addColor(new or(I,"groundColor"),"value").name("groundColor"),Y.add(I,"intensity",0,2,.01);{const Lt=new nm,ct=new em;Lt.load("SportsCar.mtl",vt=>{vt.preload();for(const A of Object.values(vt.materials))A.side=Oe;ct.setMaterials(vt),ct.load("SportsCar.obj",A=>{W.add(A)})})}const W=new Op;W.add(x),W.add(v),W.add(v.target),W.add(T),W.add(w),W.add(I);const K=2,Z=2,V=2,tt=new hi(K,Z,V),J=1,ut=32,Nt=16,Gt=new Ts(J,ut,Nt),X=2.5,et=0;function ht(Lt,ct,vt){const A=new _r({map:vt}),_=new ve(Lt,A);return W.add(_),_.position.x=ct,_.position.y=_.position.y+2.5,_}function st(Lt,ct,vt){const A=new vr({color:ct}),_=new ve(Lt,A);return W.add(_),_.position.x=vt,_.position.y=_.position.y+2.5,_.position.z=_.position.z-5,_}function At(Lt,ct,vt,A){let _=new ws(Lt,ct);const F=new _r({color:vt}),k=new ve(_,F);return W.add(k),k.position.x=A,k.position.y=k.position.y+5,k}const Tt=[ht(tt,-5,p)],Ot=[st(Gt,65280,0)],N=[At(X,et,16711680,5)];function Pt(Lt){const ct=Lt.domElement,vt=window.devicePixelRatio,A=Math.floor(ct.clientWidth*vt),_=Math.floor(ct.clientHeight*vt),F=ct.width!==A||ct.height!==_;return F&&Lt.setSize(A,_,!1),F}function _t(Lt){if(Lt*=.001,Pt(t)===!0){const A=t.domElement;a.aspect=A.clientWidth/A.clientHeight,a.updateProjectionMatrix()}Tt.forEach((A,_)=>{const F=1+_*.1,k=Lt*F;A.rotation.x=k,A.rotation.y=k}),Ot.forEach((A,_)=>{const F=1+_*.1,k=Lt*F;A.rotation.x=k,A.rotation.y=k}),N.forEach((A,_)=>{const F=1+_*.1,k=Lt*F;A.rotation.x=k,A.rotation.y=k});const vt=new cr().load("cubemap.png",()=>{vt.mapping=ur,vt.colorSpace=_e,W.background=vt});vt.colorspace=_e,t.render(W,a),requestAnimationFrame(_t)}requestAnimationFrame(_t)}gm();
